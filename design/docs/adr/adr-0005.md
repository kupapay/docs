...
## Review
Reevaluate if: (1) Phase 1 pilot feedback reveals that the target segment requires offline fiscalization (Note: This trigger was activated, leading to [ADR-0006](adr-0006.md) for Delegated Offline Signing), (2) the DGI publishes regulations mandating hardware-only fiscal signing, or (3) a competitor captures the B2B segment before Bono Pay reaches market.
